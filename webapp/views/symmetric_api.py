...
def sm4_encrypt(data):
    from utils.symmetric.sm4 import compute_encrypt
...
def sm4_decrypt(data):
    from utils.symmetric.sm4 import compute_decrypt
...
def rc6_encrypt(data):
    from utils.symmetric.rc6 import compute_encrypt
...
def rc6_decrypt(data):
    from utils.symmetric.rc6 import compute_decrypt
