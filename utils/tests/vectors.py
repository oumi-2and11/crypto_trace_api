...
TEST_VECTORS = {
    ...
    "SM4": [
        {
            "name": "SM4 ECB encrypt (GB/T 32907-2016)",
            "operation": "encrypt",
        ...
        {
            "name": "SM4 ECB decrypt (GB/T 32907-2016)",
            "operation": "decrypt",
            "input": "681edf34d206965e86b3e94f536e4246",
            "key": "0123456789abcdeffedcba9876543210",
            "mode": "ECB",
            "padding": "none",
            "output": "hex",
    ...
    "RC6": [
        {
            "name": "RC6-32/20/16 ECB encrypt (all-zero)",
            "operation": "encrypt",
        ...
        {
            "name": "RC6-32/20/16 ECB decrypt (all-zero)",
            "operation": "decrypt",
